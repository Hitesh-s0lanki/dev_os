...
; ----------------------------------
; FAT12 Boot Sector + Extended Info
; ----------------------------------
jmp short start
nop
...
start:
    ...
    ; Jump to ensure CS:IP = 0x0000:0x7C00
    push es
    push word .after
    retf
.after:
    ...
    ; Compute root dir size in sectors
...
.load_kernel_loop:
    ...
    add ax, 31                ; cluster 2 starts at LBA 33
    mov cl, 1
    mov dl, [ebr_drive_number]
    call disk_read
